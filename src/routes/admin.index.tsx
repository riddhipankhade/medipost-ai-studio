...
import { Users, CreditCard, Sparkles, Activity } from "lucide-react";
...
const stats = [
  ...
  { label: "Total Content Generated", value: "48,310", delta: "+6,420 this week", icon: Sparkles },
  { label: "Recent Activity (24h)", value: "1,902", delta: "+12% vs yesterday", icon: Activity },
];
